...
import io.home4Me.Security.authentication.identity.user.LoginDetails;
import io.home4Me.Security.authentication.identity.user.LoginDetailsDao;
import io.home4Me.Security.authentication.identity.user.RoleService;
import io.home4Me.Security.authentication.identity.user.RolesDao;
import io.home4Me.Security.authentication.identity.user.UserRoles;
...
public class UserDaoWithRolesDaoTest {
	...
	private final RoleService roleService = rolesConfiguration.roleService();
	...
	public void setUpUsers() {
		//this.firstUser = new LoginDetails(null, new Username(USER1_USERNAME), new Password(USER1_PASSWORD), LocalDateTime.now())
				.id(null)
				.email(USER1_EMAIL)
	...
	public void testCrudOperationsUsersDaoWithRolesDao() {
		...
		this.rolesConfiguration = new RolesConfiguration(roleDao);
